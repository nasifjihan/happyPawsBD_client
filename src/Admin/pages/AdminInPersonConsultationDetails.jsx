...
const AdminInPersonConsultationDetails = () => {
  const { id } = useParams();
      ...
      {isError ? (
        <Alert severity="warning" sx={{ mb: 3 }}>
          {error?.response?.data?.message ||
            "Could not load this in-person consultation request."}
        </Alert>
      ) : null}
      ...
      {updateMutation.isError ? (
        <Alert severity="error" sx={{ mb: 3 }}>
          {updateMutation.error?.response?.data?.message ||
            "Could not update this in-person consultation request."}
        </Alert>
      ) : null}
            ...
            <Stack spacing={3}>
              ...
              <Paper sx={{ p: 3, borderRadius: 4 }}>
                <Stack spacing={1.25}>
                  ...
                  <Divider />
                  <Typography>
                    <strong>City:</strong> {consultation.city || "—"}
                  </Typography>
                  <Typography>
