...
import {
  adminListInPersonConsultations,
  adminUpdateInPersonConsultation,
} from "../lib/adminApi";
import { useAdminListQueryState } from "../lib/useAdminListQueryState";

const statuses = ["new", "reviewed", "scheduled", "completed", "cancelled"];
...
const AdminInPersonConsultations = () => {
  const {
    page,
    setPage,
    q: searchTerm,
  ...
  const errorMessage =
    error?.response?.data?.message || "Could not load in-person consultations.";
  ...
  return (
    <Box>
      ...
      <Typography color="text.secondary" sx={{ mb: 3 }}>
        Review appointment requests that require a clinic visit.
      </Typography>
      ...
      <AdminFilterToolbar
        ...
        helperText="Matched in-person consultation requests across all pages"
        onReset={() => {
          setSearchTerm("");
          setStatusFilter("all");
          setPage(1);
        ...
        <Stack spacing={2}>
          {isLoading ? (
            ...
            <Typography color="text.secondary">
              No in-person consultations matched your filters.
            </Typography>
          )}
